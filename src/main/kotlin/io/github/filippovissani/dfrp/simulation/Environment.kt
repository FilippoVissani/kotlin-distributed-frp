...
interface Environment {
    ...
    companion object {
        ...
        private fun grid(columns: Int, rows: Int, candidateNeighbors: (Int, Int) -> Iterable<Pair<Int, Int>>): Environment = object : Environment {
            ...
            override fun position(device: Int): Pair<Double, Double> = Pair(col(device).toDouble(), row(device).toDouble())
